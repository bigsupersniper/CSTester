...
public class BlowfishECB
{
    ...
    protected long EncryptBlock(long lPlainBlock)
    {
        ...
        uint nHi = LongHight32(lPlainBlock);
        uint nLo = LongLower32(lPlainBlock);
    ...
    protected long DecryptBlock(long lCipherBlock)
    {
        ...
        uint nHi = LongHight32(lCipherBlock);
        uint nLo = LongLower32(lCipherBlock);
